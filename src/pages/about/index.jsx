      ...
      <Container>
        ...
        <div className="containerAbout">
          ...
          <div className="kenzie left">
            ...
            <h1>
              Todo o conhecimento utilizado para criar este website,foi
              explicado e conduzido pela Kenzie Academy Brasil
            </h1>
          </div>
          <div className="teamAnounce">
          ...
          <div className="kenzie right">
            <h1>
              Foi a API utilizada neste projeto, feita por um dos facilitadores
              da Kenzie, Gabriel Araújo
            </h1>
            <a
              className="api"
              target="_blank"
